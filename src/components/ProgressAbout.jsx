              ...
              <div className="progress-container flex flex-col gap-5">
                <div className="progress-bar">
                  ...
                  <div className="sup-progress relative bg-gray-200 w-full h-1 rounded">
                    <div className="sub-progress absolute top-0 left-0 w-[90%] h-full rounded bg-indigo-500"></div>
                  </div>
                </div>
                <div className="progress-bar">
                  <div className="progress-head flex justify-between mb-1">
                  ...
                  <div className="sup-progress relative bg-gray-200 w-full h-1 rounded">
                    <div className="sub-progress absolute top-0 left-0 w-[75%] h-full rounded bg-indigo-500"></div>
                  </div>
                </div>
                <div className="progress-bar">
                  <div className="progress-head flex justify-between mb-1">
                  ...
                  <div className="sup-progress relative bg-gray-200 w-full h-1 rounded">
                    <div className="sub-progress absolute top-0 left-0 w-[85%] h-full rounded bg-indigo-500"></div>
                  </div>
                </div>
              </div>
              <Link
                href=""
                className="bg-indigo-500 rounded text-white text-xs font-bold px-5 py-3 w-fit mt-5"
              >
                Learn More
              </Link>
            </div>
